...
namespace GCLibrary.Trades
{
    ...
    {
        public LongTrade(decimal price, decimal stoploss, decimal target, decimal minimumRisk, decimal maximumRisk, decimal minimumReward, decimal maximumReward, string? note)
            : base(price, stoploss, target, minimumRisk, maximumRisk, minimumReward, maximumReward, note)
        {
            _price = price;
